...
@FindBy(xpath = (".//*[@accesskey=\"q\"]"))
    ...
    public Authorization_page add_invalid_login(){
        login_field.click();
        login_field.sendKeys("Invalid_Login");
        return this;
    }
    ...
    public Authorization_page add_invalid_password(){
        password_field.click();
        password_field.sendKeys("Invalid_Password");
        return this;
    }
